...
class ExCheckChecklistController(Controller):
    ...
    def start_checklist(self, templateuid: str, checklistname: str, checklist_description: str, config_loader,
                        checklist_content: bytes = b"", *args, **kwargs):
        ...
        for checklist_task in parsed_checklist.find("checklistTasks").findall("checklistTask"):
            ...
            parsed_checklist.find("checklistTasks").append(
                etree.fromstring(self.wintak_adapter.standardize_task(etree.tostring(checklist_task))))
    ...
    def update_checklist_task(self, checklistuid, checklisttaskuid, checklisttaskdata, client_uid="anonymous", *args,
                              **kwargs):
    ...
    def get_all_checklists(self, config_loader, logger, *args, **kwargs):
        ...
        checklists = etree.tostring(complete_checklists, encoding='UTF-8', method='xml', standalone="yes").replace(
            b"\n", b"")
    ...
    def get_checklist_mission(self, checklist_id, config_loader, *args, **kwargss):
        ...
        self.mission_controller.complete_mission_info(mission_info, mission_elements_metadata, checklist_id,
                                                      config_loader)
    ...
    def add_checklist_to_mission(self, checklist_id, mission_id, client_uid, *args, **kwargs):
        ...
        self.request.set_value("mission_external_data", {
            ...
            "urlData": "https://" + config.DataPackageServiceDefaultIP + ":" + str(
                config.HTTPSTakAPIPort) + "/Marti/api/excheck/checklist/" + checklist.PrimaryKey,
            "urlView": "https://" + config.DataPackageServiceDefaultIP + ":" + str(
                config.HTTPSTakAPIPort) + "/Marti/api/excheck/checklist/" + checklist.PrimaryKey + "/status",
