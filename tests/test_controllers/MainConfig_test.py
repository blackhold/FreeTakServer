...
class MainConfig:
    ...
    _defaults = {
        ...
        "nodeID": {"default": _node_id, "type": str},
    ...
    def reset(cls):
        ...
        cls._defaults["nodeID"]["default"] = cls._node_id
    ...
    first_start = os.environ.get("FTS_FIRST_START", "true").lower() in ('true', 't', '1', 'yes',
                                                                        'y') and not os.path.exists(
        f"{PERSISTENCE_PATH}/installation.json")